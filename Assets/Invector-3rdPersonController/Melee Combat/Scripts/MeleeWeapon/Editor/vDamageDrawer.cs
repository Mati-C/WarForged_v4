...
namespace Invector.vMelee
{
    ...
    public class vDamageDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (isOpen)
            {
                ...
                if (!valid)
                {
                    ...
                    var content = new GUIContent("You can configure damage options for each attack animation states in the animator controller");
        ...
        {
            return !isOpen ? 25 : valid? 190 :75+helpBoxHeight;
        }
    }
}