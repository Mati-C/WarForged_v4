...
namespace Invector.vShooter
{
    ...
    public class vShooterManager : vMonoBehaviour
    {
        ...
        public virtual void ReloadWeapon(bool ignoreAmmo = false, bool ignoreAnim = false)
        {
        ...
        public virtual void ReloadWeaponAuto(vShooterWeapon weapon, bool ignoreAmmo, bool secundaryWeapon = false)
        {
            if (!weapon) return;
            UpdateTotalAmmo();
        ...
        public virtual vShooterWeapon CurrentWeapon
        {
            get
            {
                var _weapon = rWeapon && rWeapon.gameObject.activeInHierarchy ?
                    rWeapon :
                    lWeapon && lWeapon.gameObject.activeInHierarchy ?
                    lWeapon : null;
                return _weapon;
            }
        }
        ...
        public virtual bool IsLeftWeapon
        {
            get
            {
                var isLeftWp = (rWeapon == null || !rWeapon.gameObject.activeInHierarchy) ?                    
                    (lWeapon && lWeapon.gameObject.activeInHierarchy) : false;
                return isLeftWp;
            }
        }
