...
namespace Invector.vItemManager
{
    ...
    public class vItemManagerEditor : vEditorBase
    {
        ...
        string[] ignoreProperties = new string[] { "equipPoints", "applyAttributeEvents", "items", "startItems", "onUseItem", "onAddItem", "onChangeItemAmount", "onLeaveItem", "onDropItem", "onOpenCloseInventory", "onEquipItem", "onUnequipItem" };
        bool[] inEdition;
