...
Shader "N_Shaders/ThunderEffect"
{
	Properties
	{
		...
		_COLOR_01("COLOR_01", Color) = (0.2761192,0,1,0)
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 lerpResult52 = lerp( ( _COLOR_01 * fresnelNode11 * 0.437474 ) , float4( panner4, 0.0 , 0.0 ) , float4( 0,0,0,0 ));
			float2 temp_cast_2 = (0.53).xx;
			float2 temp_cast_3 = (0.14).xx;
			float2 uv_TexCoord71 = i.uv_texcoord * temp_cast_2 + temp_cast_3;
			float2 temp_cast_4 = (0.88).xx;
			float cos67 = cos( _Time.y );
			float sin67 = sin( _Time.y );
			float2 rotator67 = mul( uv_TexCoord71 - temp_cast_4 , float2x2( cos67 , -sin67 , sin67 , cos67 )) + temp_cast_4;
			float4 lerpResult86 = lerp( ( ( _Thunder_COLOR * lerpResult16 ) + lerpResult52 ) , float4( 0,0,0,0 ) , float4( rotator67, 0.0 , 0.0 ));
...
/*ASEBEGIN
Version=16900
858;474;1235;753;14.60803;1222.404;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;37;-799.6234,-1160.313;Float;False;Property;_PowerTime;PowerTime;7;0;Create;True;0;0;False;0;0;0.14;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;50;-931.825,-798.5845;Float;False;Property;_Scale_Time;Scale_Time;8;0;Create;True;0;0;False;0;0;3;0;4;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;13;-672.9836,-587.8264;Float;False;Property;_COLOR_01;COLOR_01;3;0;Create;True;0;0;False;0;0.2761192,0,1,0;0.2411,0.780932,0.8113207,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;17;-668.2092,-1810.077;Float;True;Property;_Thunder_02;Thunder_02;6;0;Create;True;0;0;False;0;86c775c92700fb74bbf0caf655318598;8804ac111ca8c9844bb1a9ca7b98fe51;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;23;165.5647,-1920.413;Float;False;Property;_Thunder_COLOR;Thunder_COLOR;4;0;Create;True;0;0;False;0;0.5115387,0.2896938,0.5849056,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PannerNode;4;218.1828,-1031.611;Float;True;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;24;1030.366,-1807.411;Float;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.LerpOp;86;1358.589,-1952.248;Float;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;80;306.713,-2569.357;Float;False;Property;_Float6;Float 6;10;0;Create;True;0;0;False;0;5;0.07;0;5;0;1;FLOAT;0
...
WireConnection;86;0;24;0
WireConnection;86;2;67;0
...
ASEEND*/
//CHKSM=91DBC933A31185A2144CE3A447F076DD37940F63